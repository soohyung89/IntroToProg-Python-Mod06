...
# Soohyung Lee,02/23/21,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        ...
        :param list_of_rows: (list) of dictionary that are consist of task and priority
        :return: 'success'
        """
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        :param task: (string) to be removed from list
        :param list_of_rows: (list) of dictionary that are consist of task and priority
        """
    ...
    def write_data_to_file(file_name, list_of_rows):
        """ Writes data stored in the list to text file
        :param file_name: (string) with name of text file
        :param list_of_rows: (list) of dictionary that are consist of task and priority
        """
        objFile = open(file_name, list_of_rows)
        for row in list_of_rows:
...
class IO:
    ...
    def input_new_task_and_priority():
        """Input new task and priority from user
    ...
    def input_task_to_remove():
        """Input task to be removed from the list
        :return: task
        """
